    ...
    <div class="min-h-screen flex flex-col flex-auto flex-shrink-0 antialiased bg-white dark:bg-gray-700 text-black dark:text-white">
      ...
      <div class="fixed flex flex-col top-14 left-0 w-14 hover:w-64 md:w-64 bg-blue-900 dark:bg-gray-900 h-full text-white transition-all duration-300 border-none z-10 sidebar">
        <div class="overflow-y-auto overflow-x-hidden flex flex-col justify-between flex-grow">
          <ul class="flex flex-col py-4 space-y-1">
            ...
            <li>
              <a href="Add.php" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-blue-800 dark:hover:bg-gray-600 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-blue-500 dark:hover:border-gray-800 pr-6">
                <span class="inline-flex justify-center items-center ml-4">
      ...
      <div class="h-full ml-14 mt-14 mb-10 md:ml-64">
        ...
        <div class="w-full max-w-md">
          <form action="code.php" method="post"  class="bg-white shadow-lg rounded px-12 pt-6 pb-8 mb-4">
            <!-- @csrf -->
            <div
            ...
            <div class="mb-4">
              ...
              <input type="radio" name="n7" value="Male"
               
               
                placeholder="Gender" >Male
                
              
              <input type="radio"    name="n7" value="Female"
            ...
            <div class="mb-6">
              ...
              <input class=""
                ...
                type="checkbox"  name="n8[]" value="yoga"
                placeholder="Hobbies"
              
              />Yoga
              <input
               
                type="checkbox"  name="n8[]" value="Music"
                placeholder="Hobbies"
              
              />Music
              <input
              
                type="checkbox"name="n8[]" value="Hobbies"
                placeholder="Hobbies"
                
              />Dance
           </div>
           <input type="submit" name="sub" class="w-16 bg-blue-500 rounded-md text-white text-center font-semibold">
          </form>
        </div>
      </div>
</div>
