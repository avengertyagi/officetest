...
$conn=mysqli_connect("localhost","root","","testing");
	...
	$que="SELECT * FROM user_info";	//select all data
            ...
            <div class="w-full overflow-x-auto">
              <table class="w-full">
                ...
                <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                  ...
                  <th  class="px-4 py-3"><?php echo $arr[0]; ?></th>
                  <th class="px-4 py-3"><?php echo $arr[1]; ?></th>
                  <th  class="px-4 py-3"><?php echo $arr[2]; ?></th>
                  <th  class="px-4 py-3"><?php echo $arr[3]; ?></th>
                  <th  class="px-4 py-3"><?php echo $arr[4]; ?></th>
                  <th  class="px-4 py-3"><?php echo $arr[5]; ?></th>
                  <th  class="px-4 py-3"><?php echo $arr[6]; ?></th>
                  <th  class="px-4 py-3"><?php echo $arr[7]; ?></th>
                  <th  class="px-4 py-3"><?php echo $arr[8]; ?></th>
                  </tr>
